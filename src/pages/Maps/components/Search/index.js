...
class Search extends React.Component {
    ...
    searchMaps(e) {
        ...
        fetch(
            `https://maps.googleapis.com/maps/api/place/autocomplete/json?input=${e}&key=AIzaSyCQldRa6xIAW6KUA6wZ6tno_Y7vZKXnWj8&sessiontoken=1234567890`,
            {
                method: 'GET',
            },
        )
        ...
        return (
            <ScrollView>
                <View style={styles.container}>
                    ...
                    {this.state.info ? this.state.info.map((item, i) => {
                    }) : <View/>}
